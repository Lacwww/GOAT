...
<div align="center"><h2 class="text-primary" style="color: green; margin-top: 10%;"><b>장소 등록</b></h2></div>
<br>
<div style="width: 100%;">
...
// 			            infowindow.open(map, marker);
		...
		<form action="adminInsertPlace.do" name="frm" onsubmit="return Chk()" method="post" enctype="multipart/form-data">
			...
			<table  style="width: 75%;">
				<tr><td class="bgcolor" align="center" style="width: 18%;">장소 이름  </td>
					<td style="width: 53%;">
					<input type="text" class="form-control" style="width: 50%; margin-left: 10px;" name="place_name" autofocus="autofocus" required="required"></td></tr>
				...
				<tr><td class="bgcolor" align="center">태그</td>
					<td><input type="text" name="place_tag" class="form-control" style="width: 70%; margin-left: 10px;" size="40" required="required"></td></tr>
				<tr><td class="bgcolor" align="center">지번 주소</td>
					<td><input type="text" name="place_addr" class="form-control" style="width: 70%; margin-left: 10px;" size="40" required="required"></td></tr>
				<tr><td class="bgcolor" align="center">도로명 주소</td>
					<td><input type="text" class="form-control" style="width: 70%; margin-left: 10px;" name="place_addrd" size="40"></td></tr>
				<tr><td class="bgcolor" align="center">장소 설명</td>
				<td><textarea rows="5" cols="50" style="margin-left: 10px;" class="form-control" name="place_content" required="required"></textarea></td></tr>
				<tr><td colspan="3" align="center">
					<input type="submit" style="margin-top: 5px;" class="btn btn1" value="등록">
