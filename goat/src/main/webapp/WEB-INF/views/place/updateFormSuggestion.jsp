...
<body>
<div align="center"><h2>건의 사항 수정</h2></div>
<div class="container">
...
// 			            infowindow.open(map, marker);
		...
		<form action="updateSuggestion.do" name="frm" onsubmit="return Chk()" method="post" enctype="multipart/form-data">			
			...
			<table>
				...
				<tr><th>태그</th><th><input type="text" name="temp_tag" size="40" required="required" value="${tp.temp_tag }"></th></tr>
				<tr><th>지번 주소</th><th><input type="text" name="temp_addr" size="40" required="required" value="${tp.temp_addr }"></th></tr>
				<tr><th>도로명 주소</th><th><input type="text" name="temp_addrd" size="40" value="${tp.temp_addrd }"></th></tr>
				<tr><th>장소 설명</th>
				<th><textarea rows="5" cols="50" name="temp_content" required="required">${tp.temp_content }</textarea></th></tr>
				<tr><th>건의 이유</th>
				<th><textarea rows="5" cols="50" name="temp_explanation" required="required">${tp.temp_explanation }</textarea></th></tr>
