...
<body>
<div align="center"><h2 class="text-primary" style="color: green;"><b>건의 사항 수정</b></h2></div>
<br>
<div class="container" style="margin-left: 9%; width: 85%;">
		<div><img id="imgpreview" style="width:450px; height: 400px;" src="${tp.temp_photo }"> </div>
		...
		<script>
			...
			var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
			    mapOption = {
			        center: new kakao.maps.LatLng(${tp.lat}, ${tp.lng}), // 지도의 중심좌표
			        level: 3 // 지도의 확대 레벨
			    };  
...
// 			            infowindow.open(map, marker);
		...
		<form action="updateSuggestion.do" name="frm" onsubmit="return Chk()" method="post" enctype="multipart/form-data">			
			<input type="hidden" name="temp_num" value="${tp.temp_num }">
			<input type="hidden" name="lat" value="${tp.lat }">
			<input type="hidden" name="lng" value="${tp.lng }">
			<div align="center">
			<table style="width: 93%;">
				<tr><td style="width: 38%;">
					<input type="file" class="form-control" name="file" id="temp_photo"></td>
					<td class="bgcolor" align="center" style="width: 10%;">장소 검색</td>
					<td style="width: 34%;"><input type="text" class="form-control" style="width: 80%; display: inline;margin-left:5px; margin-right: 5px;" name="mapSearch">
			...
			<table style="width: 75%;">
				...
				<tr><td class="bgcolor" align="center">태그</td>
					<td><input type="text" name="temp_tag" class="form-control" style="width: 70%; margin-left: 10px;" size="40" required="required" value="${tp.temp_tag }"></td></tr>
				<tr><td class="bgcolor" align="center">지번 주소</td>
					<td><input type="text" name="temp_addr" class="form-control" style="width: 70%; margin-left: 10px;" size="40" required="required" value="${tp.temp_addr }"></td></tr>
				<tr><td class="bgcolor" align="center">도로명 주소</td>
					<td><input type="text" name="temp_addrd" class="form-control" style="width: 70%; margin-left: 10px;" size="40" value="${tp.temp_addrd }"></td></tr>
				<tr><td class="bgcolor" align="center">장소 설명</td>
					<td><textarea rows="5" cols="50" name="temp_content" style="margin-left: 10px;" required="required">${tp.temp_content }</textarea></td></tr>
				<tr><td class="bgcolor" align="center">건의 이유</td>
					<td><textarea rows="5" cols="50" name="temp_explanation" style="margin-left: 10px;" required="required">${tp.temp_explanation }</textarea></td></tr>
