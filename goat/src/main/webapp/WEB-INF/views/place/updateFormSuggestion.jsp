...
<div align="center"><h2 class="text-primary" style="color: green; margin-top: 10%;"><b>건의 사항 수정</b></h2></div>
<br>
<div style="width: 100%;">
		...
		<form action="updateSuggestion.do" name="frm" onsubmit="return Chk()" method="post" enctype="multipart/form-data">			
			...
			<table style="width: 75%;">
				...
				<tr><td class="bgcolor" align="center">장소 설명</td>
					<td><textarea rows="5" cols="50" class="form-control" name="temp_content" style="margin-left: 10px;" required="required">${tp.temp_content }</textarea></td></tr>
				<tr><td class="bgcolor" align="center">건의 이유</td>
					<td><textarea rows="5" cols="50" class="form-control" name="temp_explanation" style="margin-left: 10px;" required="required">${tp.temp_explanation }</textarea></td></tr>
