			...
			<tr align="center">
				...
				<c:if test="${empty keyword }">
					<c:if test="${prevUrl == 'member' }">
						<input type="button" onclick="location.href='${path }/member/tripList.do?m_num=${m_num }'" value="게시글 목록">
					</c:if>
					<c:if test="${prevUrl != 'member' }">
						<input type="button" onclick="location.href='tripList.do?pageNum=${pageNum }'" value="게시글 목록">
					</c:if>
				</c:if>
				<c:if test="${not empty keyword }">
					...
					<c:if test="${prevUrl != 'member' }">
						<input type="button" onclick="location.href='tripSearch.do?pageNum=${pageNum }&search=${search}&keyword=${keyword}'" value="게시글 목록">
					</c:if>
				</c:if>
					
				<c:if test="${m_num == trip.m_num || not empty admin}">
					<input type="button" onclick="location.href='tripUpdateForm.do?t_num=${trip.t_num}&pageNum=${pageNum }'" value="수정">
					<input type="button" onclick="delTrip()" value="삭제">
				</c:if>
				</td>
			</tr>
		</table>
