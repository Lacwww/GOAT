		...
		<div id="wrapper">
			<div style="display:flex;align-items: flex-start;flex-direction: column;">
				<p id="sch_date"><img src="${path }/resources/images/calendar.png" style="width: 60px; height: 70px; padding-bottom: 5px;">
				 ${s_date } ~ ${e_date }</p>
				<input type="text" id="sch_name" name="sch_name" placeholder="나만의 스케줄 이름을 입력해주세요" style="margin-bottom: 1%;">
			</div>
			<!-- 지도 -->
				...
				<c:forEach var="d" begin="1" end="${days }">
					<div id="day${d }">
						<table class="table talbe-striped" id="table-${d }">
							<caption style="caption-side: top;">DAY ${d }</caption>
							<tr>
								<th>여행 순서</th>
								<th>장소명</th>
								<th>주소</th>
			...
			<div class="btn" style="width: 100%;" align="center"  style="display: flex;">
				<div style="display:flex;align-items: center;justify-content: space-between;">
					...
					<div style="margin-right:15%;">
						...
						<input type="button" onclick="back()" value="이전" class="btn btn-cancel">
					</div>
					<div></div>
				</div>
			</div>
