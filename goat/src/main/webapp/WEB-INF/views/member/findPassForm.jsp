			...
			<div style="width: 100%;">
				<h1 style="margin-bottom: 50px;">Find Password</h1>
			 	<form action="findPassResult.do?" method="post">
			 		<div align="center">
			 			<input type="text" name="m_id" placeholder="ID" required="required" autofocus="autofocus" class="data">
			 		</div>
			 		<div align="center">
			 			<input type="email" name="m_email" placeholder="Email" required="required" class="data">
			 		</div>
			 		<div align="center">
			 			<input type="submit" value="Find Password" class="btn btn-success" style="margin: 10px; width: 145.5px;">
			 		</div>
